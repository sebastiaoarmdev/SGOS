...
uses
  ...
  System.Generics.Collections, FireDAC.Stan.Param, UMapper, UDMMain, UItemOS;

type
  TItemOSMapper = class(TMapper<TItemOS>)
  public
    function FindAllByOrdemId(AOrdemId: Integer): TObjectList<TItemOS>;
    function FindById(AId: Integer): TItemOS; override;
    procedure Save(AItemOS: TItemOS); override;
    procedure Delete(AItemOS: TItemOS); override;
  end;
